...
export function RelatedPosts({ posts }: RelatedPostsProps) {
  ...
  return (
    <section
      className="mt-12 border-t border-(--border) pt-8 sm:mt-16 lg:mt-20 lg:pt-10"
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between lg:mb-8">
        <div>
          <h2
            ...
            className="text-sm uppercase tracking-wide text-(--muted) lg:text-[0.82rem]"
          >
            Further reading
          </h2>
        ...
        <Link
          href="/blog"
          className="focus-ring inline-flex min-h-10 items-center gap-2 self-start rounded-sm text-sm text-(--foreground-soft) transition hover:text-(--foreground) sm:self-auto lg:text-[0.95rem]"
        >
          Archive
