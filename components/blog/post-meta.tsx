...
export function PostMeta({ date, readingTime, updated, published = true, className }: PostMetaProps) {
  return (
    <div className={cn("flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-[var(--muted)] lg:gap-x-5 lg:text-[0.82rem]", className)}>
      ...
      {!published ? (
        <span className="inline-flex items-center gap-1.5 rounded bg-[rgb(0_217_255_/_0.1)] px-2 py-0.5 text-[var(--accent)] lg:px-2.5 lg:py-1">
