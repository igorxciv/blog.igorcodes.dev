...
<ProcessFlow
  ...
  steps={[
    "Problem: name the technical issue in one sentence",
    "Impact: connect it to users, business, delivery, or team health",
    "Proposal: ask for a specific investment with scope and validation",
  ]}
/>
