...
<ProcessFlow
  ...
  steps="Encounter a problem you cannot yet solve fluently | Form a hypothesis or attempt a solution | Observe mismatch, error, or failure | Debug the mismatch and update your model | Reuse that model on the next problem"
  mutedSteps="Prompt for a solution | Paste the output | Move on without building causal understanding"
/>
...
<PostImage
  name="knowledge-gaps"
  alt="Editorial placeholder for a layered diagram where missing foundational blocks destabilize the higher layers."
  caption="Replace this placeholder with the final illustration for the compounding-knowledge-gaps section."
/>
