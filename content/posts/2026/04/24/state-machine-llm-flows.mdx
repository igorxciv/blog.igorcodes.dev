...
<ProcessFlow
  title="The new loop"
  steps="Backend reads current state | User message updates known facts | LLM receives state plus latest input | LLM returns a structured next turn | Backend validates and persists"
